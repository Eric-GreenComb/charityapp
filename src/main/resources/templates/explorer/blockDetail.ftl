...
<div class="section">
    <div class="container">
        <div class="partYi">
            ...
            <p class="partInfo"><span>时间戳</span><span>${blockInfo.blockGenTime}</span></p>
            <p class="partInfo"><span>世界态哈希</span><span>${blockInfo.stateHash}</span></p>
            <p class="partInfo"><span>上一区块</span><span>${blockInfo.previousBlockHash}</span></p>
        </div>
        
        <div class="partYi">
        	<#list blockInfo.transactions as trans>
